            ...
            <div class="col-sm-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                      <!-- Start panel body--> 
                    <form class="form-horizontal" name="formulario" role="form" action="<?php echo site_url('admin_teacher/add_teacher'); ?>" method="post">
                        <div class="row">
                            <div class="col-xs-12">
                            ...
                            <div class="col-xs-4"> 
                                ...
                                <input name="perfil" type="hidden" value="docente" class="form-control"> 
                            </div>
                            ...
                            <div class="col-xs-4"> 
                             ...
                             <div class="clearfix">
                                    ...
                                    <div class="col-xs-4"> 
                                        <label for="input-@gray-lighter">Matricula del docente:</label><br>  
                                ...
                                <div class="clearfix"></div> 
                                    ...
                                    <div class="clearfix"></div> 
                                     <div class="col-xs-4"> 
                                        <br><button class="btn btn-primary" type="submit" onclick="cifrar();" value="Registrar">Guardar</button>
                                    </div>
                                     <div class="col-xs-4">
                                    </div>
                                    <div class="col-xs-4">
    ...
    $("form").submit(function (event){
        ...
        $.ajax({
            ...
            success:function(respuesta){
                if (respuesta == "ok"){
                    swal("Bien hecho", "El profesor se ha registrado correctamente", "success");
                 }  
                 else {
