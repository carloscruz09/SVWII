...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="<?php echo base_url(); ?>assets/images/avatar-principal.png" width="30" height="30">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="<?php echo site_url('login_admin/logout_ci'); ?>"><i class="fa fa-key"></i> Log Out</a></li>
            </ul>
        </li>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    <li><a href="<?php echo site_url('admin_student/new_student'); ?>">Agregar</a></li>
                    <li><a href="<?php echo site_url('admin_student/search_student'); ?>">Buscar</a></li>
                </ul>
            </li>
            <li class="sub-menu">
                <a href="javascript:;">
                ...
                <ul class="sub">
                    <li><a href="<?php echo site_url('admin_teacher/new_teacher'); ?>">Agregar</a></li>
                    <li><a href="<?php echo site_url('admin_teacher/search_teacher'); ?>">Buscar</a></li>
                </ul>
            </li>
            <li class="sub-menu">
                <a href="javascript:;">
                ...
                <ul class="sub">
                    <li><a href="<?php echo site_url('admin_admin/new_admin'); ?>">Agregar</a></li>
                    <li><a href="<?php echo site_url('admin_admin/search_admin'); ?>">Buscar</a></li>
                </ul>
            </li>
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    <li><a href="<?php echo site_url('admin_subject/new_subject'); ?>">Agregar</a></li>
                    <li><a href="<?php echo site_url('admin_subject/search_subject'); ?>">Buscar</a></li>
                </ul>
            </li>
            <li>
                <a href="<?php echo site_url('admin_group/search_group'); ?>">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    <li><a href="<?php echo site_url('admin/index'); ?>">Agregar</a></li>
                    <li><a href="<?php echo site_url('admin/index'); ?>">Buscar</a></li>
                </ul>
            </li>
            <li>
