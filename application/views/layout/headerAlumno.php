...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="<?php echo base_url(); ?>assets/images/avatar-student2.png" width="30" height="30">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="<?php echo site_url('login_alumno/logout_ci'); ?>"><i class="fa fa-key"></i> Log Out</a></li>
            </ul>
        </li>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    <li><a href="<?php echo site_url('person/agregar_alumnos');?>">Calificaciones</a></li>
                    <li><a href="<?php echo site_url('person/buscar_alumnos'); ?>">Horario</a></li>
                    <li><a href="<?php echo site_url('person/buscar_alumnos'); ?>">Asistencias</a></li>
                    <li><a href="<?php echo site_url('person/buscar_alumnos'); ?>">Boleta</a></li>
                    <li><a href="<?php echo site_url('person/buscar_alumnos'); ?>">Kardex</a></li>
                </ul>
            </li>
            <li class="sub-menu">
                <a href="javascript:;">
                ...
                <ul class="sub">
                    <li><a href="<?php echo site_url('person/construccion'); ?>">Historial de pagos</a></li>
                    <li><a href="<?php echo site_url('person/construccion'); ?>">Adeudos</a></li>
                </ul>
            </li>        
            <li class="sub-menu">
                <a href="javascript:;">
                ...
                <ul class="sub">
                    <li><a href="<?php echo site_url('person/construccion'); ?>">Historial</a></li>
                </ul>
            </li>
            <li>
